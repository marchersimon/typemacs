...
;; Package-Version: 20201204.1326
;; Package-Commit: e4d5c9641c7ce1a3cc3fb52a4c7bd81ed8d3e401
;; Created: 10 Sep 2013
...
;; possible layout values: azerty, azerty-be, colemak, colemak-mod-dh, dvorak, programer-dvorak, qwerty, qwerty-abnt, qwerty-no (qwerty Norwegian), qwertz, workman, norman, koy
...
(defvar xah--dvorak-to-koy-kmap
  '(("." . "o")
    ...
    ("y" . "y")
    ("z" . "j"))
  "A alist, each element is of the form(\"e\" . \"d\"). First char is Dvorak, second is corresponding KOY. Not all chars are in the list, such as digits. When not in this alist, they are assumed to be the same.")
